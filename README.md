...
# Logbook for Check 2
| Status      | Date         | Severity | Description                                            | Expected Result                                          | Actual Result                                            |
|-------------|--------------|----------|--------------------------------------------------------|----------------------------------------------------------|----------------------------------------------------------|
| Completed   | Mar 3, 2023  | Medium   | Started working on Firebase user authentication        | Users should be able to sign up and log in using Firebase authentication                                           | -                                                        |
| Completed   | Mar 8, 2023  | High     | Encountered an error during authentication setup       | Authentication setup should be error-free and functioning properly                                                | Fixed the error and authentication setup is now working as expected                                                  |
| Completed   | Mar 13, 2023 | Low      | Implemented email verification for new users           | New users should receive a verification email and be prompted to verify their email before accessing the system   | -                                                        |
| Completed   | Mar 17, 2023 | Medium   | Users unable to reset their passwords                  | Users should be able to reset their passwords via the "Forgot Password" feature                                   | Fixed the issue and users can now reset their passwords successfully                                                |
| Completed   | Mar 23, 2023 | Low      | Implementing encryption for user data                  | User data should be securely encrypted and stored in Firebase database                                            | Encryption implemented successfully and user data is securely stored                                                 |
| Completed   | Apr 1, 2023  | High     | Performance issues with authentication                  | Authentication operations should be fast and responsive                                                           | Investigating the performance issues and optimizing the authentication process                                     |
| Completed   | Apr 6, 2023  | Medium   | Improved error handling and error messages             | Users should receive clear and informative error messages when authentication fails                               | Enhanced error handling and error messages implemented                                                             |
| Completed   | Apr 12, 2023 | Low      | Implementing two-factor authentication (2FA)           | Users should have the option to enable 2FA for added security                                                     | 2FA feature successfully implemented and users can enable it for their accounts                                   |
| Completed   | Apr 18, 2023 | Medium   | User feedback: UI/UX improvements                      | Users have reported issues with the authentication UI/UX                                                           | Working on UI/UX improvements based on user feedback                                                                |
| Completed   | Apr 26, 2023 | Low      | Integrated social media login (Google, Facebook)       | Users should be able to sign in using their Google or Facebook accounts                                           | Social media login integration completed and users can sign in using Google or Facebook accounts                  |
| In Progress | May 4, 2023  | High     | Cross-platform compatibility issues                    | The authentication system should work seamlessly across various platforms                                          | -                                                        |
| Completed   | May 9, 2023  | Medium   | Testing and bug fixes                                  | The authentication system should be thoroughly tested and any bugs should be fixed                                 | Conducted extensive testing and fixed reported bugs                                                                |
| Completed   | May 15, 2023 | Low      | Documentation and user guide updates                   | The documentation should be updated with the new authentication features and user guide should be improved        | Documentation and user guide updated with the latest authentication features                                      |
| Completed   | May 20, 2023 | Medium   | Security audit and vulnerability fixes                  | Conducted a security audit to identify vulnerabilities and implemented necessary fixes                            | Security vulnerabilities fixed and system audited for improved security                                           |
| In Progress | Jun 1, 2023  | Medium   | Creating editing defect support |
| In Progress | 2023-06-02 | High     | Implement creating/editing defect support       | Users should be able to create/edit defects    | -                                              |
| Completed   | 2023-06-05 | High     | Implement creating/editing defect support       | Users can now create/edit defects               | Users successfully create/edit defects         |
| In Progress | 2023-06-06 | Medium   | Add local images support                         | Users should be able to upload and display images | -                                              |
| Completed   | 2023-06-08 | Medium   | Add local images support                         | Users can now upload and display images         | Users successfully upload and display images   |
| In Progress | 2023-06-10 | Low      | Implement cross-browser support                 | Application should work consistently on all major browsers | -                                      |
| In Progress | 2023-06-14 | Low      | Implement cross-browser support                 | Resolving compatibility issues                  | -                                              |
| Completed   | 2023-06-17 | Low      | Implement cross-browser support                 | Application works consistently on all major browsers | Application now works on all major browsers |
