...
const ProjectDetails = () => {
        ...
        db.collection('projects')
                ...
                db.collection('users')
                    ...
                    .then(querySnapshot => {
                        querySnapshot.forEach(function (doc) {
                            ...
                            const { displayName, email, role, projects } =
                                doc.data()
            ...
            .then(() => {
                ...
                db.collection('tickets')
                    ...
                    .catch(error => {
                        console.error(
                            "Ticket priorities couldn't be fetched: ",
                            error
                        )
                    })
            })
    ...
    const handleRemoveMember =
        (memberId: string) => (event: React.FormEvent) => {
            event.preventDefault()
            ...
            db.collection('users')
                ...
                .then((doc: firestore.DocumentData) => {
                    if (doc.exists) {
                        ...
                        if (
                            projectsArray &&
                            projectsArray.includes(projectId)
                        ) {
                            projectsArray.splice(
                                projectsArray.indexOf(projectId),
                                1
                            )
                        } else {
